...
class Video_Caption_Generator():
    ...
    def build_generator(self, sess, video, tf_word_index, tf_probs, tf_state2, tf_state1, state_feed, state1_feed, input_feed, length_normalization_factor=0.2):
        ...
        word_index, probs, state2, state1 = self.sess.run([tf_word_index, tf_probs, tf_state2, tf_state1],
                                                     feed_dict={state_feed: state2, state1_feed: state1, input_feed: initial_word})
        ...
        for i in range(1, self.n_caption_lstm_step):
            ...
            for mid_caption in mid_captions:
                ...
                word_index, probs,state2, state1 = self.sess.run([tf_word_index, tf_probs, tf_state2, tf_state1], feed_dict={state_feed: mid_language_state_feed,state1_feed: mid_img_state_feed, input_feed: mid_input_feed})
