...
outfile = 'new_s2vt_models/att_batch64_s2vt_trainlr1e-3.txt'
outmodel = 'att_new_s2vt_modellr1e-3'
# =======================================================================================
# Train Parameters
# =======================================================================================
dim_image = 1536
...
def test(model_path='/data1/lijun/tensorflow_s2vt/new_s2vt_models/'):
    test_captions, test_features = get_video_feature_caption_pair(video_test_sent_file, video_test_feature_file)
    ...
    for i in xrange(15,16):
        model_path_last = model_path + 'batch_size64_new_s2vt_model-' + str(i)
...
def evaluation(model_path='/data1/lijun/tensorflow_s2vt/new_s2vt_models/'):
    start_time = time.time()
    test_captions, test_features = get_video_feature_caption_pair(video_test_sent_file, video_test_feature_file)
    ...
    with open('new_s2vt_models/batch64_s2vt_test_one.txt', 'a') as f:
      for i in xrange(22,23,1):
        model_path_last = model_path + 'batch_size64_new_s2vt_model-'+str(i)
        saver.restore(sess, model_path_last)
        all_decoded_for_eval = {}
        test_index = list(range(len(test_captions)))
