...
out_file = 'fix_models/fix_models_attribute_fc_1stlstm_1e-4_dim1000_sum.txt'
...
def evaluation(model_path='/home/llj/tensorflow_s2vt/fix_models/'):
    ...
    with open('fix_models/batch_size16_fix_models_attribute_fc_2ndlstm_1e-4_dim1000_sum_test.txt', 'a') as f:
      for i in xrange(9,10,1):
        model_path_last = model_path + 'batch_size16_fix_models_attribute_fc_2ndlstm_1e-4_dim1000_sum-' +str(i)
        saver.restore(sess,model_path_last)
        all_decoded_for_eval = {}
        test_index = list(range(len(test_captions)))
        random.shuffle(test_index)
