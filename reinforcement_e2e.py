...
model_path = './reinforcement_e2e_models'
...
feature_model ='/data1/lijun/tensorflow_s2vt/new_attribute_models/5_lr_1e-05_batch_size16alpha_1attribute_model-14000'
#feature_model = '/data1/lijun/tensorflow_s2vt/new_attribute_models/5batch_size8alpha_0.01attribute_model-8000'
#lstm_model ='/data1/lijun/tensorflow_s2vt/new_s2vt_models/batch_size64_new_s2vt_model-22'
#lstm_model = '/data1/lijun/tensorflow_s2vt/reinforcement_models/best_multisampling_sentence_model/reinforce_multisample8_model-14'
lstm_model = '/data1/lijun/tensorflow_s2vt/new_s2vt_models/batch_size64att_new_s2vt_model-10'
...
out_file = 'reinforcement_e2e_models/reinf_att.txt'

save_model_name = 'reinforce_att'

save_loss_imgs = 'reinforce_e2e_alpha005'

save_cider_imgs = 'reinforce_e2e_alpha005'
...
def train():  ###### move caption (input_sentence) one column left and also need to move caption_mask (cont_sent)one column left ########################################################llj
    ...
    sum_loss = -tf.reduce_sum(tf.transpose(tf.multiply(tf.transpose(loss,[2,1,0]), residual),[2,1,0]))/norm ############# loss function
...
def evaluation(model_path='/data1/lijun/tensorflow_s2vt/reinforcement_e2e_models/'):#home/llj/tensorflow_s2vt/reinforcement_multitask_models/'):
    start_time = time.time()
    ...
    with open('reinforcement_e2e_models/reinforce_multitask_basedon_8reinfo_multisamp_test1.txt', 'a') as f:
      for i in xrange(20000, 23000, 2000):
        model_path_last = model_path + '5batch_size16reinforce_e2e_model_alpha005-' + str(i)
        saver.restore(sess, model_path_last)
        all_decoded_for_eval = {}
        test_index = list(range(len(test_captions)))
        random.shuffle(test_index)
